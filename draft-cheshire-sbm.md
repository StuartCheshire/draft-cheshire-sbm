...
This document offers techniques and guidance for host
networking software to avoid unnecessary delays for network
traffic caused by excessive buffering at the sender, which
